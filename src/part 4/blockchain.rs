...
const GENESIS_COINBASE_DATA: &str = "The times 14.11.23 of start in this blockchain.";
#[derive(Debug, Clone)]
...
impl Blockchain {
    ...
    /// CreateBlockchain crates a new blockchain DB
    pub fn create_blockchain(address: String) -> Result<Blockchain> {
        info!("Creating new blockchain"); 

        let db = sled::open("data/blocks")?;
        info!("Creating new block database");
        let cbtx = Transcation::new_coinbase(address, String::from("GENESIS_COINBASE_DATA"))?;
...
mod tests{
    ...
    fn test_add_block(){
        ...
        // b.add_block("data 01".to_string());
        // b.add_block("data 02".to_string());
        // b.add_block("data 03".to_string());
