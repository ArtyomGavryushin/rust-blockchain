...
impl Transaction {
    ...
    /// IsCoinbase chesks whether the transcation is coinbase
    pub fn is_counbase(&self) -> bool {
...
impl TXOutput {
    /// CanBeUnlockedWith checks if the output can be unlocked with the proveded data
